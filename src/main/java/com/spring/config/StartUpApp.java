...
public class StartUpApp implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userService.findAll().isEmpty()){
            ...
            userService.save(new AppUser(null, "Ahmed Mohamed", "12345", adminRoles));
            userService.save(new AppUser(null, "Kamal Ali", "12345", userRoles));
            userService.save(new AppUser(null, "Ramy Helal", "12345", employeeRoles));
        }
